...
/*	The maxCoordinateDistance heuristic function calculates the maximum coordinate distance for each tile and adds the Manhattan distance to it,
	...
	// either use the configured input while calling giving "boardlocation.txt" as parameter 0 and "solutionLocation.txt" as parameter 1;
	// or use the manual in file inputs through the main below.
	public static void main(String [] args) throws IOException {
		...
		// OR TYPE2: follow the following manual inputting by changing the input file name and solution file name
		File input = new File("./testcases/board01.txt");
		Solver compute = new Solver(input);
		String fileName = "./solutions/board01Solution.txt";
